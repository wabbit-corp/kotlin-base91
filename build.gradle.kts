...
mavenPublishing {
    coordinates("one.wabbit", "kotlin-base91", "0.1.0")
    publishToMavenCentral()
    signAllPublications()
    pom {
        name.set("kotlin-base91")
        description.set("kotlin-base91")
        url.set("https://github.com/wabbit-corp/kotlin-base91")
        licenses {
            license {
        ...
        scm {
            url.set("https://github.com/wabbit-corp/kotlin-base91")
            connection.set("scm:git:git://github.com/wabbit-corp/kotlin-base91.git")
            developerConnection.set("scm:git:ssh://git@github.com/wabbit-corp/kotlin-base91.git")
        }
    }
}
...
dokka {
    ...
    dokkaSourceSets.configureEach {
        ...
        sourceLink {
            ...
            remoteUrl("https://github.com/wabbit-corp/kotlin-base91/tree/master/src")
